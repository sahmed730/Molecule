...
function App() {
  ...
  const [activeTab, setActiveTab] = useState<'ai' | 'blank'>('ai');
  ...
  // Global Tab State
  const { activeTabId, openedTabs, setActiveTabId, closeTab } = useAppStore();
  ...
  const handleGenerateArchitecture = async (
    ...
    const finalPrompt = finalPromptOverride || prompt;
              ...
              {activeTabId === 'canvas' ? (
                <>
                  ...
                  <CanvasEditor
                    ...
                    onRegenerate={(p) => handleGenerateArchitecture(p)}
                    onNewProject={() => {
                      setAppState('home');
                      setPrompt('');
                      setGeneratedNodes([]);
